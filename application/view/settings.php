		...
		<div id="page-content" style="min-height: 378px;">
			...
			<div class="block full">
				...
				<div class="block-title">
					<h2>Events And Details <small></small></h2>
				</div>
				...
				<div style="font-size:20px"  class="row">
					<div class="col-lg-7 col-md-12 col-sm-12">
						...
						<ul data-toggle="tabs" class="nav nav-tabs push">
							...
							<li class="" onclick="clearForm();"><a href="#example-tabs-profile"><i class="gi gi-roundabout"></i> Status</a></li>
							...
							<li class="" onclick="clearForm();"><a href="#example-tabs-pastEvents" data-original-title="Events"><i class="gi gi-group"></i> Past events</a></li>
						
						</ul>
						<div  style="font-size:20px" class="tab-content">
								...
								<div id="example-data2" class="table-responsive" >
									<table id="example-datatable2" class="table table-vcenter table-hover table-condensed table-bordered">
										...
										<tbody>
											...
											echo "<tr id='Row2".$i."' onclick='getSelected(\"status\",\"".$event->id."\")'><td id='Col2".$i."'>".$event->ordinal."</td><td id='Col2".$i."'>".$event->name."</td><td id='Col2".$i."'>".$event->displayName."</td></tr>";
											$i=$i+1;
										}?>			
										</tbody>
									</table>
								...
								<div id="example-data5" class="table-responsive" >
									<table id="example-datatable5" class="table table-vcenter table-hover table-condensed table-bordered">
										...
										<tbody>
											...
											echo "<tr id='Row5".$i."' onclick='getSelected(\"statusNewDef\",\"".$event->id."\")'><td id='Col5".$i."'>".$event->ordinal."</td><td id='Col5".$i."'>".$event->name."</td><td id='Col5".$i."'>".$event->displayName."</td></tr>";
											$i=$i+1;
										}?>			
										</tbody>
									</table>
							...
							<div id="example-tabs-pastEvents" class="tab-pane">									
								<div id="example-data7" class="table-responsive" >
									<table id="example-datatable7" class="table table-vcenter table-hover table-condensed table-bordered">
										<thead>
											<tr>
												<th>#</th>
												<th>Name</th>
										...
										<?php $i=1;foreach($events as $event){
											$curYear = date("Y");
											$eventYear = substr($event->evtYearFrom,3);											
											$eventYear = intVal($eventYear);
