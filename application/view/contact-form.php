			...
			<div id="page-content"  style="min-height: 780px;" >
				...
				<div class="block">
					<div class="block-title">
					   <h3 style="font-size:24px;" ><strong>New Registration</strong>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 
											...
											<div class="form-group">
												<div>
													<div class="input-group">													
														...
														<input type="text" style="font-size:20px" placeholder="First Name" class="form-control input-lg input-lg" name="fname" id="fname" value="<?php print htmlentities($fname) ?>" onchange="changeProgressBar()" />
										</div>
												</div>
											</div>
										</div>				
										<div class="col-lg-4 col-md-6 col-sm-12">
											<div class="form-group">
												<div>
													<div class="input-group">
														<span class="input-group-addon"><i class="gi gi-user"></i></span>
														<input type="text" style="font-size:20px" placeholder="Last Name" class="form-control input-lg" name="lname" id="lname" value="<?php print htmlentities($lname) ?>" onchange="changeProgressBar()"/>
													</div>
												</div>
											</div>
										</div>				
											...
											<div class="form-group">
												<div>
													<div class="input-group">
														...
														<input type="email" style="font-size:20px" placeholder="Email" class="form-control input-lg" name="l_email" id="l_email" value="<?php print htmlentities($email) ?>" onchange="changeProgressBar()"/>
													</div>
												</div>
											</div>			
										</div>				
											...
											<div class="form-group">
												<div>
													<div class="input-group"> 
														...
														<input type="text" style="font-size:20px" placeholder="Phone Number (xxx-xxx-xxxx)" class="form-control input-lg" id="mobile" name="mobile" value="<?php print htmlentities($mobile) ?>" onchange="changeProgressBar()"/>
													</div>
												</div>
											</div>
										</div>				
											...
											<div class="form-group">
												<div>
													<div class="input-group">
														...
														<input type="text" style="font-size:20px" placeholder="Date of Birth (mm/dd/yyyy)" class="form-control input-lg" id="dob" name="dob" value="<?php print htmlentities($dob) ?>" < onchange="changeProgressBar()"/>
													</div>
												</div>
											</div>
										</div>				
											...
											<div class="form-group">
												<div>
													<div class="input-group">
														...
														<select class="form-control input-lg" style="font-size:20px" placeholder="Select your gender" id ="gender" name="gender" onchange="changeProgressBar()"style="padding-top:12px;opacity:0.8"><option value="" disabled selected style='display:none;' >Select your Gender</option>
											...
											<div class="form-group">
												<div>
													<div class="input-group">
														...
														<input type="text"  style="font-size:20px" placeholder="Most Recent College" class="form-control input-lg searchCollege" id="college" name="college" data-provide="typeahead" autocomplete="off" value="<?php print htmlentities($college) ?>" onchange="changeProgressBar()"/>
													</div>
												</div>
											</div>
										</div>				
											...
											<div class="form-group">
												<div>
													<div class="input-group">
														...
														<input type="number" min='0' max='4' step="any" style="font-size:20px"  placeholder="GPA" data-mask="" data-inputmask="'mask': ['99.99', '99.99']" class="form-control input-lg" name="ssc" id="ssc" value="<?php print htmlentities($ssc) ?>" onchange="changeProgressBar()"/>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="form-group">
												<div>
													<div class="input-group"> 
														...
														<input type="text" style="font-size:20px" placeholder="Graduation Date (mm/yyyy) or Expected" data-mask="" data-inputmask="'mask': ['9999', '9999']" class="form-control input-lg" name="yearPassed" id="yearPassed" value="<?php print htmlentities($yearPassed) ?>" onchange="changeProgressBar()"/>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="form-group">
												<div>
													<div class="input-group">
														...
														<input type="text"  style="font-size:20px" placeholder="Current Employer (N/A if Umemployed)" class="form-control input-lg" name="currentCompany" value="<?php print htmlentities($currentCompany) ?>" />
													</div>	
												</div>
											</div>											
										</div>
											...
											<div class="form-group">
												<div>
													<div class="input-group"> 
														...
														<input type="number" min='0' style="font-size:20px" placeholder="How Many Months of Experience" data-mask="" data-inputmask="'mask': ['9.9', '9.9']" class="form-control input-lg" name="yearsOfExp" value="<?php print htmlentities($yearsOfExp) ?>"/>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="form-group">
												<div>
													<div class="input-group"> 
														...
														<input type="text" style="font-size:20px" id="source" name="source" placeholder="How did you know about us?" class="form-control input-lg" name="source" onchange="changeProgressBar()" value="<?php print htmlentities($source) ?>" />
													</div>
												</div>
											</div>
										</div>										
