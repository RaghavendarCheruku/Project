						...
						?>
								<div style="width:590px;height:920px;margin:10px auto;page-break-after:always;">
									...
									<div style="height:45px;">
										...
										<div style="float:right;"><img src="assets/img/-transperent2.png" width="148px" height="40px"></div>
									</div>
									<div style="text-align:center;font-weight:bold;font-size:12pt;font-family:Arial;width:100%">RECRUITMENT ANSWER SHEET</div>
									<div style="height:236px;border:1px solid black">
										...
										<div class="sectionBlocks" style="width:43px;height:79px;">
											<div>VR</div>
											<div class="section"></div>
											<div class="section" style="border-top:none"></div>
											<div class="section"></div>
										</div>
										<div class="sectionBlocks" style="width:70px;height:79px;" >
											<div>TR</div>
											<div class="section">T1:</div>
											<div class="section">T2:</div>
											<div class="section"></div>
										</div>
										<div class="sectionBlocks" style="width:50px;height:79px;" >
											<div>CR</div>
											<div class="section" ></div>
											<div class="section" style="border-top:none"></div>
											<div class="section"></div>
										...
										<div class="sectionBlocks" style="border-right:none;width:41px;height:79px;">
											<div>HR</div>
											<div class="section"></div>
											<div class="section" style="border-top:none"></div>
											<div class="section"></div>
									...
									<div style="border-top:1px solid black;font-size:10pt;font-family:Arial;padding-top:5px"><span style="float:left">CONFIDENTIAL, &copy Recruitment Examination</span><span  style="float:right">1 | Page</span></div>
								</div>
								<?php
									}					
									$tempNum++;
