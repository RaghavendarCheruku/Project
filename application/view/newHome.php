						...
						<div style="padding:0px">
							<div class="input-group ">
								...
								<select class="form-control input-md"  id ="selectRadio" >													
									<option    value="college" selected >List of Colleges from Current Candidates</option>	
									<option    value="stream"  >Majors</option>	
									<option    value="source" >How did you hear about the event</option>	
									<option    value="person"  >Personnel</option>	
									<option    value="event"  >List of Current Events</option>	
								</select>
							</div>
						</div>	
					</div>
