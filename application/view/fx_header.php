<header class="navbar navbar-default navbar-fixed-top">
	...
	<div style="font-size:20px"  class="collapse navbar-collapse" id="horizontal-menu-collapse">
		<ul class="nav navbar-nav">
			<li>
				<a href="index.php?op=atHome">Home</a>
			</li>
			<li  onclick="clearForm();"><a href="index.php?op=settings" data-original-title="Events"><i class="fa fa-cog"></i> Events</a></li>
