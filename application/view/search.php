		...
		<div id="page-content"  style="min-height: 749px;">
			...
			<div class="block">
				<div class="block-title">
					<h3 style="font-size:24px;" ><strong>Status of Existing Application</strong>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 
				...
				<div class="row">
					<div class= "col-lg-12 col-md-12 col-sm-12" >
										...
										<div class="form-group">
											<div>
												...
												<div class="input-group">
													...
													<span id="eveDm" class="input-group-addon"><font style="font-size:20px"><?php echo $prefixEve; ?></font></span>
													<input type="text" style="font-size:20px"  placeholder="Please enter your Registration ID" class="form-control input-lg" name="rID" id="rID" value="" />
												</div>
												<!--div class="input-group">	
													<span class="input-group-addon"><i class="gi gi-user"></i></span>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<div>
												<div class="input-group">	
													<span class="input-group-addon"><i class="gi gi-user"></i></span>
													<input type="email" style="font-size:20px"  placeholder="Please enter your email" class="form-control input-lg" name="remail" id="remail" value="" />
												</div>
											</div>
										</div>
									</div>									
						...
						<table class="table table-borderless table-striped" style="font-size:20px">
							<tbody>
								...
								<tr>
									...
									<td><!--a href="javascript:void(0)"--><?php echo $scontacts[0]->dob;?><!--/a--></td>
								</tr>
								<tr>
									<td><strong>Gender</strong></td>
									<td><!--a href="javascript:void(0)"--><?php   if(($scontacts[0]->gender)==1){ echo "Female";} else if (($scontacts[0]->gender)==2) { echo "Male";} else if(($scontacts[0]->gender)==3){ echo "Prefer Not to Answer";}?><!--/a--></td>
								</tr>
								<tr>
									<td><strong>GPA</strong></td>
									<td><!--a href="javascript:void(0)"--><?php echo $scontacts[0]->ssc;?><!--/a--></td>
								</tr>
								<?php
								$degree=$scontacts[0]->qualName;
									if(strpos($degree,'Other')!== false)
									{
										?>
									<tr>
									<td><strong>Other Degree</strong></td>
									<td><!--a href="javascript:void(0)"--><?php echo $scontacts[0]->degree;?><!--/a--></td>
								</tr>
									<?php
									}
									else
								...
								<tr> <td> <a href="index.php?op=edit"> Edit </a></td></tr>
								<?php					
								}
								else{?>
								<tr class="danger">	
